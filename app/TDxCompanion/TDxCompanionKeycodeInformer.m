...
#import "TDxCompanionKeycodeInformer.h"

@implementation TDxCompanionKeycodeInformer

static TDxCompanionKeycodeInformer *sharedInstance = nil;
...
- (TDxCompanionKeycodeInformer *)init {
    self = [super init];
    if (self) {
...
//
// TDxCompanionKeycodeInformer.m ends here
